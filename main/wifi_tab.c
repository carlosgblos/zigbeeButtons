...
static void style_compact_button(lv_obj_t *btn, lv_color_t color);
static void style_button_textarea(lv_obj_t *ta);
static void style_button_dropdown(lv_obj_t *dd);
static void style_settings_textarea(lv_obj_t *ta);
static void style_settings_dropdown(lv_obj_t *dd);
...
void wifi_tab_init(lv_obj_t *tab, lv_obj_t *buttons_tab)
{
    ...
    lv_obj_set_style_text_color(device_section_title, lv_color_hex(0xE2E8F0), 0);
    ...
    style_settings_textarea(s_device_id_ta);
    ...
    style_settings_textarea(s_device_name_ta);
    ...
    style_action_button(device_save_btn, lv_color_hex(0x334155));
    ...
    style_action_button(scan_btn, lv_color_hex(0x2563EB));
    ...
    lv_obj_set_flex_grow(disconnect_btn, 1);
    style_action_button(disconnect_btn, lv_color_hex(0x334155));
    ...
    style_settings_dropdown(s_dropdown);
    ...
    style_settings_textarea(s_password_ta);
    ...
    style_settings_textarea(s_mqtt_host_ta);
    ...
    style_settings_textarea(s_mqtt_user_ta);
    ...
    style_settings_textarea(s_mqtt_pass_ta);
    ...
    style_action_button(connect_btn, lv_color_hex(0x2563EB));
    ...
    style_action_button(save_btn, lv_color_hex(0x2563EB));
...
static lv_obj_t *create_settings_panel(lv_obj_t *tab, const char *title_text)
{
    ...
    lv_obj_set_style_bg_color(tab, lv_color_hex(0x12172B), 0);
...
static void build_button_config_ui(lv_obj_t *tab)
{
    ...
    lv_obj_set_style_text_color(btn_section_title, lv_color_hex(0xE2E8F0), 0);
    ...
    lv_obj_set_style_pad_gap(count_row, 12, 0);
    lv_obj_set_style_pad_all(count_row, 10, 0);
    lv_obj_set_size(count_row, LV_PCT(100), 56);
    lv_obj_set_style_radius(count_row, 8, 0);
    lv_obj_set_style_bg_color(count_row, lv_color_hex(0x0F1B33), 0);
    lv_obj_set_style_bg_opa(count_row, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(count_row, 1, 0);
    lv_obj_set_style_border_color(count_row, lv_color_hex(0x24324D), 0);
    ...
    lv_obj_set_style_text_color(count_lbl, lv_color_hex(0xE2E8F0), 0);

    lv_obj_t *dec_btn = lv_button_create(count_row);
    style_compact_button(dec_btn, lv_color_hex(0x334155));
    ...
    lv_obj_set_width(s_btn_count_label, 40);
    lv_obj_set_style_text_align(s_btn_count_label, LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_color(s_btn_count_label, lv_color_hex(0xFFFFFF), 0);
    char count_buf[4];
    ...
    style_compact_button(inc_btn, lv_color_hex(0x334155));
    ...
    for (uint8_t i = 0; i < BTN_MAX_COUNT; i++) {
        ...
        lv_obj_set_style_bg_color(row, lv_color_hex(0x0B152A), 0);
        lv_obj_set_style_bg_opa(row, LV_OPA_COVER, 0);
        lv_obj_set_style_border_width(row, 1, 0);
        lv_obj_set_style_border_color(row, lv_color_hex(0x1E2B44), 0);
        ...
        lv_obj_set_width(idx_lbl, 32);
        lv_obj_set_style_text_color(idx_lbl, lv_color_hex(0x94A3B8), 0);
        ...
        lv_obj_set_width(icon_dd, 132);
        style_button_dropdown(icon_dd);
        s_btn_icon_dd[i] = icon_dd;

        lv_obj_t *type_dd = lv_dropdown_create(row);
        lv_dropdown_set_options(type_dd, "Switch\nScene");
        lv_obj_set_width(type_dd, 104);
        style_button_dropdown(type_dd);
    ...
    lv_obj_set_height(apply_btn, 48);
    lv_obj_set_style_radius(apply_btn, 8, 0);
    lv_obj_set_style_bg_color(apply_btn, lv_color_hex(0x2563EB), 0);
...
static void style_button_textarea(lv_obj_t *ta)
{
    ...
    lv_obj_set_style_radius(ta, 7, 0);
    lv_obj_set_style_bg_color(ta, lv_color_hex(0x152238), 0);
    lv_obj_set_style_bg_opa(ta, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(ta, 1, 0);
    lv_obj_set_style_border_color(ta, lv_color_hex(0x2A3A56), 0);
    lv_obj_set_style_text_color(ta, lv_color_hex(0xF8FAFC), 0);
...
static void style_button_dropdown(lv_obj_t *dd)
{
    lv_obj_set_height(dd, 42);
    lv_obj_set_style_radius(dd, 7, 0);
    lv_obj_set_style_bg_color(dd, lv_color_hex(0x152238), 0);
    lv_obj_set_style_bg_opa(dd, LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(dd, 1, 0);
    lv_obj_set_style_border_color(dd, lv_color_hex(0x2A3A56), 0);
